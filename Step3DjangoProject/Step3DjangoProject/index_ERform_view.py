...
import sys
sys.path.append("..")
# from Step3DjangoProject.toolkit.pre_load import pre_load_thu
...
# from Step3DjangoProject.toolkit.NER import get_NE,temporaryok,get_explain,get_detail_explain
